 ...
 * @version    $Id: Type1.php 1052 2017-05-18 09:49:46Z jan.slabon $
 */
    ...
    implements SetaPDF_Core_Font_Glyph_Collection_CollectionInterface, SetaPDF_Core_Font_DescriptorInterface
{
    ...
    protected function _getWidths()
    {
        ...
        for ($i = $firstChar; $i <= $lastChar; $i++) {
            ...
            $this->_widthsByCharCode[$charCore] = $width;

            $utf16BeCodePoint = SetaPDF_Core_Encoding::toUtf16Be($table, $charCore, false, true);
