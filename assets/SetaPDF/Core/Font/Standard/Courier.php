 ...
 * @version    $Id: Courier.php 1052 2017-05-18 09:49:46Z jan.slabon $
 */
...
class SetaPDF_Core_Font_Standard_Courier extends SetaPDF_Core_Font_Standard
{
    ...
    static public function getDefaultDictionary($encoding = 'WinAnsi')
    {
        ...
        $dictionary['BaseFont'] = new SetaPDF_Core_Type_Name('Courier', true);
    ...
    public function __construct($indirectObjectOrDictionary)
    {
        ...
        $this->_info = array(
            ...
            SetaPDF_Core_Font::INFO_CREATION_DATE => 'Date: Thu May  1 17:27:09 1997',
            SetaPDF_Core_Font::INFO_UNIQUE_ID => '43050',
        ...
        $this->_fontBBox = array(-23, -250, 715, 805);
