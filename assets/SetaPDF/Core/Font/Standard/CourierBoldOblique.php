 ...
 * @version    $Id: CourierBoldOblique.php 1052 2017-05-18 09:49:46Z jan.slabon $
 */
...
class SetaPDF_Core_Font_Standard_CourierBoldOblique extends SetaPDF_Core_Font_Standard
{
    ...
    static public function getDefaultDictionary($encoding = 'WinAnsi')
    {
        ...
        $dictionary['BaseFont'] = new SetaPDF_Core_Type_Name('Courier-BoldOblique', true);
    ...
    public function __construct($indirectObjectOrDictionary)
    {
        ...
        $this->_fontName = 'Courier-BoldOblique';
        ...
        $this->_info = array(
            ...
            SetaPDF_Core_Font::INFO_CREATION_DATE => 'Date: Mon Jun 23 16:28:46 1997',
            SetaPDF_Core_Font::INFO_UNIQUE_ID => '43049',
        ...
        $this->_fontBBox = array(-57, -250, 869, 801);
