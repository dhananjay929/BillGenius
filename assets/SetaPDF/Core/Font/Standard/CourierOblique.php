 ...
 * @version    $Id: CourierOblique.php 1052 2017-05-18 09:49:46Z jan.slabon $
 */
...
class SetaPDF_Core_Font_Standard_CourierOblique extends SetaPDF_Core_Font_Standard
{
    ...
    static public function getDefaultDictionary($encoding = 'WinAnsi')
    {
        ...
        $dictionary['BaseFont'] = new SetaPDF_Core_Type_Name('Courier-Oblique', true);
    ...
    public function __construct($indirectObjectOrDictionary)
    {
        ...
        $this->_fontName = 'Courier-Oblique';
        $this->_fontFamily = 'Courier';
        
        $this->_info = array(
            SetaPDF_Core_Font::INFO_COPYRIGHT => '(c) 1989, 1990, 1991, 1992, 1993, 1997 Adobe Systems Incorporated.  All Rights Reserved.',
            SetaPDF_Core_Font::INFO_CREATION_DATE => 'Date: Thu May  1 17:37:52 1997',
            SetaPDF_Core_Font::INFO_UNIQUE_ID => '43051',
        ...
        $this->_fontBBox = array(-27, -250, 849, 805);
