 ...
 * @version    $Id: Table.php 1113 2017-10-19 14:09:34Z timo.scholz $
 */
...
abstract class SetaPDF_Core_Font_TrueType_Table
{
    ...
    protected function _get($name)
    {
        ...
        switch ($type) {
            ...
            // All test data from real TTF files were rounded with one precision
            case SetaPDF_Core_BitConverter::FIXED:

                $method = 'formatFrom' . $type;
                return round(SetaPDF_Core_BitConverter::$method($raw), 1);
        }
