 ...
 * @version    $Id: Png.php 1060 2017-06-09 10:12:40Z maximilian.kresse $
 */
    ...
    protected function _extractAlphaChannel($decodeParameters)
    {
        ...
        // gray
            ...
            for ($i = 0, $h = $this->getHeight(); $i < $h; $i++) {
                ...
                $offset++;
                for (; $offset + 1 < $lineEnd; $offset += 2) {
                    $colorImageData .= $imageData[$offset];
                    $alphaImageData .= $imageData[$offset + 1];
                }
            }
        // rgb
        } elseif ($colorSpace === 6) {
            ...
            for ($i = 0, $h = $this->getHeight(); $i < $h; $i++) {
                ...
                for (; $offset < $lineEnd; $offset += 4) {
                    $colorImageData .= substr($imageData, $offset, 3);
                    $alphaImageData .= $imageData[$offset + 3];
                }
            }
        }
        unset($imageData);
